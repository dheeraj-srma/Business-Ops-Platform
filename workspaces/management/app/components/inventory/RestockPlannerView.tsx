...
export const RestockPlannerView: React.FC<RestockPlannerViewProps> = ({
  ...
  return (
    <div id="restock-planner-view" className="p-3.5 sm:p-6 space-y-4 sm:space-y-6 w-full max-w-[1760px] 2xl:max-w-[1880px] mx-auto">
      ...
      {successMessage && (
        <div className="p-4 rounded-xl bg-cyan-50 dark:bg-cyan-950/60 border border-cyan-200 dark:border-cyan-800 text-cyan-900 dark:text-cyan-200 text-sm flex items-center gap-3 animate-in fade-in">
          <CheckCircle2 className="w-5 h-5 text-cyan-600 dark:text-indigo-600 dark:text-indigo-400 shrink-0" />
      ...
      {showFormulaGuide && (
        <div className="p-5 rounded-2xl bg-slate-900 dark:bg-slate-950 text-slate-100 border border-slate-700 shadow-xl space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            ...
            <div className="p-3.5 rounded-xl bg-slate-800/80 border border-slate-700/60 space-y-2">
              <span className="font-semibold text-indigo-600 dark:text-indigo-400 block uppercase tracking-wider text-[11px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="p-4 sm:p-5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-2xs space-y-1">
          ...
          <div className="text-xl sm:text-2xl font-bold text-cyan-600 dark:text-indigo-600 dark:text-indigo-400 font-mono mt-1">
      ...
      {selectedCount > 0 && (
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 rounded-xl bg-slate-900 dark:bg-slate-950 border border-slate-700 text-white text-xs shadow-lg animate-in fade-in">
          <div className="flex items-center gap-2.5 flex-wrap">
            <span className="font-semibold text-indigo-600 dark:text-indigo-400">{selectedCount} items selected</span>
            ...
            <span>
              Total Cost:{' '}
              <strong className="text-indigo-700 dark:text-indigo-300 font-mono">{formatCurrency(selectedTotalCost)}</strong>
            </span>
          </div>
          <div className="flex items-center gap-2">
            <button
            ...
            {isManager && (
              <button
                type="button"
                onClick={() => setIsBulkModalOpen(true)}
                className="px-3.5 py-1.5 bg-cyan-600 hover:bg-indigo-600 dark:bg-indigo-500 text-white font-bold rounded-lg cursor-pointer transition-all shadow-md shadow-cyan-600/30"
              >
                ...
                <tr>
                  <td colSpan={11} className="py-12 text-center">
                    {hasActiveFilters ? (
                      ...
                      <div>
                        <CheckCircle2 className="w-8 h-8 text-cyan-500 mx-auto mb-2" />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in">
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-2xl max-w-xl w-full p-6 space-y-5">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-700 pb-3">
              <div className="flex items-center gap-2">
                <span className="p-2 rounded-lg bg-cyan-50 dark:bg-cyan-950/60 text-cyan-600 dark:text-indigo-600 dark:text-indigo-400 border border-cyan-200 dark:border-cyan-800">
            ...
            <form onSubmit={handleBulkRestockSubmit} className="space-y-4">
              <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700 text-xs space-y-1">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-cyan-600 dark:text-indigo-600 dark:text-indigo-400 font-mono">
              ...
              <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                ...
                <button
                  ...
                  className="px-4 py-2 text-xs font-semibold text-white bg-cyan-600 dark:bg-indigo-600 dark:bg-indigo-500 rounded-lg hover:bg-cyan-700 dark:hover:bg-cyan-600 disabled:opacity-50 flex items-center gap-1.5 shadow-2xs cursor-pointer"
                >
                  {isSubmittingBulk ? (
                    <>
