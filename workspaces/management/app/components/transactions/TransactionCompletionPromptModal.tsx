...
import { CheckCircle2, FileSpreadsheet, FileCode, ArrowRight, X, Download } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            <div className={`w-11 h-11 rounded-2xl text-white flex items-center justify-center shadow-lg shrink-0 ${
              isReturn
                ...
                : isStockIn
                ? 'bg-indigo-600 dark:bg-indigo-500 shadow-indigo-500/25'
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="p-3.5 rounded-2xl border-2 border-indigo-200 dark:border-indigo-800/60 hover:border-indigo-600 dark:border-indigo-500 bg-cyan-50/50 dark:bg-cyan-950/30 hover:bg-cyan-50 dark:hover:bg-cyan-950/60 transition-all flex flex-col items-center justify-center gap-2 text-center group cursor-pointer shadow-xs hover:shadow-md hover:-translate-y-0.5 active:translate-y-0"
              >
                <div className="w-9 h-9 rounded-xl bg-cyan-600 text-white flex items-center justify-center shadow-md shadow-cyan-600/25 group-hover:scale-110 transition-transform">
                  <FileSpreadsheet className="w-5 h-5" />
                </div>
                <div>
                  <span className="text-xs font-bold text-slate-900 dark:text-white block">Download Excel</span>
                  <span className="text-[10px] text-cyan-700 dark:text-indigo-600 dark:text-indigo-400 font-medium">Spreadsheet (.xlsx)</span>
                </div>
              </button>
