...
import { StockTransaction, Category } from '../../types';
...
export const TransactionHistoryView: React.FC<TransactionHistoryViewProps> = ({
  ...
  return (
    <div id="transactions-view" className="p-3.5 sm:p-6 space-y-4 sm:space-y-6 w-full max-w-[1760px] 2xl:max-w-[1880px] mx-auto">
                      ...
                      <div className="flex items-start sm:items-center gap-3.5 flex-1 min-w-0">
                        ...
                        <div
                          className={cn(
                            ...
                            isStockIn && 'bg-cyan-50 dark:bg-indigo-50 dark:bg-indigo-950/80 text-cyan-600 dark:text-indigo-600 dark:text-indigo-400 border border-cyan-200 dark:border-cyan-800/80',
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <span
                              className={cn(
                                ...
                                isStockIn && 'bg-cyan-50 dark:bg-cyan-950 text-cyan-700 dark:text-indigo-700 dark:text-indigo-300 border border-cyan-200 dark:border-cyan-800',
                      ...
                      <td className="py-3 px-4 whitespace-nowrap">
                        <span
                          className={cn(
                            ...
                            txType === 'STOCK_IN' && 'bg-cyan-100 dark:bg-cyan-950/60 text-cyan-800 dark:text-indigo-700 dark:text-indigo-300 border border-cyan-200 dark:border-indigo-200 dark:border-indigo-800/60',
